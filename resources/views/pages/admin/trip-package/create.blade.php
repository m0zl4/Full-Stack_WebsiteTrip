...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Tambah Paket Pulang</h1>
        </div>
        ...
        <div class="card shadow">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="driver" placeholder="Driver" value="{{ old('driver') }}">
                </div>
                ...
                <button type="sumbit" class="btn btn-primary btn-block">Simpan</button>
                </form>
            </div>
        </div>
