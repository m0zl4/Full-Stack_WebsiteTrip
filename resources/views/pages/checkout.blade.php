        ...
        <div class="row">
            ...
            <div class="card card-details">
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="{{ route('checkout-remove', $detail->id) }}">
                          <img src="{{ url('frontend/image/ic_remove.jpg') }}" height="18">
                        </a>
                      </td>
                    </tr>
                    @empty
              ...
              <div class="member mt-3">
                ...
                <form class="form-inline" method="post" action="{{ route('checkout-create', $item->id) }}">
                  ...
                  <label for="doePassport" class="sr-only">DEO Transit</label>
          ...
          <div class="col-lg-4">
             <div class="card card-details card-right">
               ...
               <table class="trip-informations">
                ...
                <tr>
                  ...
                  <td width="50%" class="text-right">
                    Rp {{ $item->trip_package->price }} / person
                  </td>
                </tr>
                <tr>
             ...
             <div class="order-container">
               <a href="{{ route('checkout-success', $item->id) }}" class="btn btn-block btn-order-now mt-3 py-2">
                  I Have Made Payment
               </a>
             </div>
             <div class="text-center mt-3">
              <a href="{{ route('details', $item->trip_package->slug) }}}" class="text-muted">Cancel Booking</a>
            </div>
          </div>
        </div>
      </div>
